...
INSERT INTO sys_config (id, key, value, status, remark) VALUES ('2', 'MASTER_JMETER_HOME_KEY', '/Users/huyuwei/apache-jmeter-5.2', '1', '本地Jmeter_home绝对路径');
INSERT INTO sys_config (id, key, value, status, remark) VALUES ('3', 'MASTER_JMETER_CASES_HOME_KEY', '/Users/huyuwei/Downloads/stressTestCases', '1', '本地保存用例数据的绝对路径，不要随意切换会导致文件找不到错误。');
